  ...
  <div class="container" style="font-family: 'Ovo', serif;">
    ...
    <form action="process/insert-datadiri.php" method="POST" enctype="multipart/form-data" style="width: 500px; display: inline-block;margin-left: 300px;">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="nik" name="nik" value="<?= $row['NIK']; ?>" disabled>
      </div>

      <div class="form-group">
        <label for="name">Nama Lengkap</label>
        <input type="name" class="form-control" id="name" name="nama" value="<?= $row['namaPenghuni']; ?>" disabled>
      </div>

      <div class="form-group">
        <label for="name">Jenis Kelamin</label>
        <input type="text" class="form-control" id="jenisKelamin" name="jenisKelamin" value="<?= $row['jenisKelamin']; ?>" disabled>
      </div>

      <div class="form-group">
        <label for="tglLahir">Tanggal Lahir</label>
        <input type="date" class="form-control" id="tglLahir" name="tglLahir" value="<?= $row['tanggalLahir']; ?>" disabled>
      </div>

      <div class="form-group">
        <label for="pekerjaan">Pekerjaan</label>
        <input type="text" class="form-control" id="pekerjaan" name="pekerjaan" value="<?= $row['pekerjaan']; ?>" disabled>
      </div>
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="telepon" name="telepon" value="<?= $row['telepon']; ?>" disabled>
      </div>
    </form>
    <br>
    <button onclick="location.href='pengajuansewa-pemilik.php'" class="btn btn-primary" style="margin-left:520px;">Back</button>
  </div>
