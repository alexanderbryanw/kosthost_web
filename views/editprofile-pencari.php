...
<body>
    ...
    <div class="container" style="font-family: 'Ovo', serif;">
        ...
        <form action="../process/edit-pencari.php" method="post" enctype="multipart/form-data" style="width: 500px; display: inline-block;margin-left: 300px;">

            <div class="form-group">
                <label for="namaPencari">Nama Lengkap</label>
                <input type="text" class="form-control" id="namaPencari" name="namaPencari" value="<?= $data['namaPencari'] ?>">
            </div>
            <div class="form-group">
