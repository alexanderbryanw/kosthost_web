...
<body>
    ...
    <div class="container" style="font-family: 'Ovo', serif;">
        ...
        <form action="../process/edit-pemilik.php" method="post" enctype="multipart/form-data" style="width: 500px; display: inline-block;margin-left: 300px;">

            <div class="form-group">
                <label for="namaPemilik">Nama Lengkap</label>
                <input type="text" class="form-control" id="namaPemilik" name="namaPemilik" value="<?= $data['namaPemilik'] ?>">
            </div>
            <div class="form-group">
